        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <motion.a
              ...
              className="flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-lg font-medium glow"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-4 py-2 bg-primary text-primary-foreground rounded-lg font-medium w-fit"
                onClick={() => setIsOpen(false)}
              >
                <FileText className="w-4 h-4" />
                Resume
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <span className="font-mono text-primary font-bold">{"<Shiva />"}</span>
            <span className="text-muted-foreground">
              © {new Date().getFullYear()} Shivatharun S
            </span>
          </div>
